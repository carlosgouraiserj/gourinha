...
class MainActivity : AppCompatActivity() {
    ...
    private fun jogadaComputador() {
        ...
        // Atualizar o botão correspondente com a imagem do Vasco
        val posicao = rX * 3 + rY
        when (posicao) {
    ...
    private fun reiniciarJogo() {
        // Implementar a lógica para reiniciar o jogo, se necessário
        // Pode incluir a limpeza do tabuleiro e a reinicialização de variáveis
    }
}
