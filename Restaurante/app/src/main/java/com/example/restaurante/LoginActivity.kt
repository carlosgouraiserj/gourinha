...
// Cria a variavel binding que serve para manipular a tela.
    private lateinit var binding:ActivityLoginBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        // Define o layout de Login e a atribui a variavel binding.
       ...
       // Manda Android usar o layout especificado pelo binding.root para exibir a interface do usuário da atividade atual
        ...
        binding.buttonEntrar.setOnClickListener {
            ...
            // Define os valores da variavel para o nome de Usuário e a Senha inserida pelo usuário, converte para String e elimina os espaços em branco.
            ...
            if (username.equals("abc") && password.equals("123")) {
                ...
                // Adiciona o nome de usuário como extra para intent
              ...
              // Inicia o MainActivity
               ...
               // Finaliza o LoginActivity
                ...
                // Se o usuário e a senha estiverem incorretos, mostra uma mensagem de erro.
